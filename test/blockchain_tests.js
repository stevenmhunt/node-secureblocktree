...
describe('Blocktree Layer 1 - Blockchain', () => {
    ...
    describe('write block', () => {
        ...
        it('should throw an exception if writing to an invalid blockchain if validation is enabled.', async () => {
            // arrange
            const blockchain = initBlockchain();
        ...
        it('should not throw an exception if writing to an invalid blockchain if validation is disabled.', async () => {
            // arrange
            const blockchain = initBlockchain();
