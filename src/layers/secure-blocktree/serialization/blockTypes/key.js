...
const { serializeKey } = require('../serialize');
const { deserializeKey } = require('../deserialize');
...
module.exports = {
     ...
     */
    serialize: function serializeKeyBlock({
     ...
     */
    deserialize: function deserializeKeyBlock(data, startIndex = 0) {
        const result = {};
